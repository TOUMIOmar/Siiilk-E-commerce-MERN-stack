...
const Signup = () => {
  ...
  const [effet,addeffet]=useState("container-login sign-up-mode")
  ...
  <div className="panels-container">
    <div className="panel left-panel">
      <div className="content-c">
        ...
        <button onClick={removeeffett} className="btn-0 transparent" id="sign-up-btn" >
        S'inscrire
        </button>
      </div>
    ...
    <div className="panel right-panel">
      <div className="content-c">
        ...
        <button  onClick={addeffett} className="btn-0 transparent" id="sign-in-btn">
        S'identifier
        </button>
      </div>
